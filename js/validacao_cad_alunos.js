...
function validar_cad_aluno() {
    ...
    if(data_nasc.value == "" || data_nasc.value == null) {
        ...
        data_nasc.focus();
        data_nasc.style.border= "1xp solid red";
        return false; 
    }
    ...
    if(sexo.value == "" || sexo.value == null) {
        ...
        sexo.focus();
        sexo.style.border= "1xp solid red";
        return false; 
    }
    ...
    if(genero.value == "" || genero.value == null) {
        ...
        genero.focus();
        genero.style.border= "1xp solid red";
        return false; 
    }
    ...
    if(cpf.value == "" || cpf.value == null) {
        ...
        cpf.focus();
        cpf.style.border= "1xp solid red";
        return false; 
    }
    ...
    if(cidade.value == "" || cidade.value == null) {
        ...
        cidade.focus();
        cidade.style.border= "1xp solid red";
        return false; 
    }
    ...
    if(estado.value == "" || estado.value == null) {
        alert("Por favor, informe o genero.");
        estado.focus();
        estado.style.border= "1xp solid red";
        return false; 
    }
}